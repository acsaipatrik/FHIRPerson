...
public class filtertwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtertwo);
    ...
    private void queryData() {
        ...
        mPersons.orderBy("birthDate").startAt(currentDate).get().addOnSuccessListener(queryDocumentSnapshots -> {
